...
- This endpoint also works for `.mp4` files.  Use the `Content-Duration` header (ex: `Content-Duration: 2000`) to indicate the length of the `.mp4` file in ms.  The maximum timeout period is 5mins.
