...
Rendition-Name: 360p
```
_note: if the `multipart` file looks different, most likely there was an issue with your request.  Please visit our [support channel on Discord](https://discord.gg/98g8Dqn), or email support@livepeer.org.

You can use something like [`munpack`](https://linux.die.net/man/1/munpack) to unpack the multipart file. For example:
```
munpack multipart
```
You should see:
