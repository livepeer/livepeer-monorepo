...
Before transcoding your stream of .ts segments, be sure to [create a stream with defined rendition profiles](/docs/segment_based_ingest/create_a_stream_and_define_renditions) and [gather a list of broadcasters](/docs/segment_based_ingest/get_a_list_of_broadcasters). It may also be helpful to review how to [authenticate](/docs/segment_based_ingest/authentication).
