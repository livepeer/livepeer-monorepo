...
| **RTMP ingest URL** |  |    Your RTMP ingest URL is based on the region your stream originates in. The regional ingest URLs are the following: <ul><li>North America: rtmp://na-ingest-url/<strong>stream-key</strong></li><li>EU: rtmp://eu-ingest-url/<strong>stream-key</strong></li></ul> |
| **Playback URL** |  | The playback URL is https://playback-url.com/<strong>stream-name</strong>|
